...
<head>
<title>AdWords API .NET client library - Table of Content</title>
...
<iframe id="TopicContent" name="TopicContent" class="TopicContent" src="html/R_Project_google-api-adwords-dotnet.htm">
